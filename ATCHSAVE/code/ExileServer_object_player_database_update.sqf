...
[
	...
	backpack _player,
	((getItemCargo backpackContainer _player) call ExileClient_util_cargo_getMap) + (_player call ExileServer_util_getWeaponAttachementCargo),
	((backpackContainer _player) call ExileClient_util_cargo_getMagazineMap) + (_player call ExileServer_util_getWeaponMagCargo),
